...
프로젝트를 "목적 → 완료"까지 단계로 몰아가는 방법. 각 기어는 `progress.md`의 자기 칸을 채우고 다음 단계로 넘긴다. 개발자용 gstack의 비개발 버전. **현재 1~4단계 구현, 5~7 예정.** (형식은 `10-projects/README.md`의 "Do Better Drive 진행" 참조.)
...
<<<<<<< HEAD
- `drive-frame` → `drive-scope` → `drive-plan` → `drive-make` (프로젝트 `progress.md`를 통해 단계별로 이어짐)
...
>>>>>>> fe80ec795b8e1218a1078c0528e1ed2f6294df38
